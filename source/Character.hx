...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'justice':
                ...
                animation.addByPrefix('singUP', 'Justice_upDANCE', 24, false);
                animation.addByPrefix('singRIGHT', 'Justice_rightDANCE', 24, false);
                animation.addByPrefix('singDOWN', 'Justice_downDANCE', 24, false);
                animation.addByPrefix('singLEFT', 'Justice_leftDANCE', 24, false);
				animation.addByPrefix('laugh', 'Justice_laughDANCE', 24, false);
				animation.addByPrefix('pigeon', 'Justice_tauntPIDGEON', 24, false);
        
                addOffset('idle');
                addOffset("singUP", 19, 3);
                addOffset("singRIGHT", 2, 14);
                addOffset("singLEFT", 23, 20);
                addOffset("singDOWN", 49, -18);
				addOffset("laugh", -1, 44);
				addOffset("pigeon", 3, -7);
			...
			case 'justice2':
                ...
                frames = tex;
                animation.addByPrefix('idle', 'Justice_idleDANCE', 24);
                animation.addByPrefix('ugh', 'Justice_tauntSCOFF', 24, false);
			...
			case 'bf-justice':
                tex = Paths.getSparrowAtlas('justice/assets/BoyFriend_Assets-Justice', 'shared');
			...
			case 'bf-pigeon':
				...
				animation.addByPrefix('scared', 'BF idle SHIVERIN', 24);

				addOffset('idle', -6, 70);
				addOffset("singUP", -12, 60);
				addOffset("singRIGHT", -26, 51);
				addOffset("singLEFT", 68, 40);
				addOffset("singDOWN", 28, -19);
				addOffset("singUPmiss", -16, 83);
				addOffset("singRIGHTmiss", -22, 59);
				addOffset("singLEFTmiss", 63, 56);
				addOffset("singDOWNmiss", 20, 0);
				addOffset("hey", -17, 83);
				addOffset('firstDeath', 37, 11);
				addOffset('deathLoop', 37, 5);
				addOffset('deathConfirm', 37, 69);
				addOffset('scared', 1, 64);
	...
	public function dance()
	{
		if (!debugMode)
		{
			...
			{
				case 'justice':
					if (!animation.curAnim.name.startsWith('laugh'))
						if (!animation.curAnim.name.startsWith('pigeon'))
					{
					playAnim('idle');
					}
				
				case 'justice2':
					if (!animation.curAnim.name.startsWith('ugh'))
					{
					playAnim('idle');
					}
				...
				case 'gf-kids':
					if (!animation.curAnim.name.startsWith('Disappointment'))
					{
						danced = !danced;
